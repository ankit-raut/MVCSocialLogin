...
using SocialLoginAssignment.Models;
...
namespace SocialLoginAssignment
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            (
                clientId: ConfigurationManager.AppSettings["LinkedinClientId"].ToString(),
                clientSecret: ConfigurationManager.AppSettings["LinkedinClientSecret"].ToString()
            );
